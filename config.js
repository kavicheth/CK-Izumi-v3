...
module.exports = {
  ...
  BOT_NAME: process.env.BOT_NAME || "CK IZUMI MD",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "CK BOTS ZONE,2024",
  AUDIO_DATA: process.env.AUDIO_DATA || "Eʏᴘᴢ;Iᴢᴜᴍɪ-ᴠ3;https://i.imgur.com/cO0TZJv.jpeg",
  PROCESSNAME: process.env.PROCESSNAME || "CK IZUMI MD V3",
  AUTHOR: process.env.AUTHOR || "2024",
